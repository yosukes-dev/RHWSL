...
base.tar:
	...
	docker run --name rhwsl registry.access.redhat.com/ubi8/ubi:8.4-199 /bin/bash -c "dnf update -y; dnf clean all; pwconv; grpconv; chmod 0744 /etc/shadow; chmod 0744 /etc/gshadow;"
...
clean:
	...
	-sudo rm -r rootfs
	-rm base.tar
	-docker rmi registry.access.redhat.com/ubi8/ubi:8.4-199
